...
export default {
  ...
  "app.simplehttpsserver.button.generateCert": "Generate Certificate",
  "app.simplehttpsserver.button.exportCert":   "Export…",
  "app.simplehttpsserver.button.importCert":   "Import…",
  "app.simplehttpsserver.picker.exportTitle":  "Export Certificate",
  "app.simplehttpsserver.picker.importTitle":  "Import Certificate",
  "app.simplehttpsserver.log.certExported":    "[{time}] Certificate exported to {path}",
  "app.simplehttpsserver.log.certExportFailed":"[{time}] ERROR: Certificate export failed",
  "app.simplehttpsserver.log.certImported":    "[{time}] Certificate imported: {subject}",
  "app.simplehttpsserver.log.certImportFailed":"[{time}] ERROR: Certificate import failed",
  "app.simplehttpsserver.cert.none":           "No certificate yet. Generate one to start the server.",
  ...
  "app.simplehttpsserver.log.noCert":          "[{time}] ERROR: No certificate — generate one first.",
  "app.simplehttpsserver.log.tlsOk":           "[{time}] TLS OK from {peer}",
  "app.simplehttpsserver.log.tlsFailed":       "[{time}] TLS failed: {reason}",
  "app.simplehttpsserver.log.certGenerated":   "[{time}] Certificate generated: {subject}",
