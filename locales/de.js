...
export default {
  ...
  "app.simpletcpclient.log.remoteClosed": "[{time}] GESCHLOSSEN {who}",
  ...
  "app.simpletcpserver.label.listenPort": "Port",
  ...
  "app.simpletcpserver.log.listening": "[{time}] ABHÖREN (TCP) auf 0.0.0.0:{port}",
  "app.simpletcpserver.log.startFailed": "[{time}] FEHLER Start fehlgeschlagen: {reason}",
  "app.simpletcpserver.log.stopped": "[{time}] GESCHLOSSEN (Lausch-Port {port} geschlossen)",
  ...
  "app.simpletcpserver.log.disconnect": "[{time}] GESCHLOSSEN {who}",
  ...
  "switch.stp.enable": "STP aktivieren",
  "switch.stp.status": "STP Status",
  "switch.vlan.config": "VLAN-Konfiguration",
  "switch.vlan.enable": "VLANS aktivieren",
  "textbox.text": "Text",
