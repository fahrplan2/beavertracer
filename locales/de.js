...
export default {
  ...
  "router.ripng.col.interface": "Schnittstelle",
  "router.ripng.col.passive": "Passiv",
  "router.ripng.log": "Protokoll",
  "router.bgp.tab": "BGP",
  ...
  "switch.lldp.empty":       "Keine LLDP-Nachbarn gefunden.",
  ...
  "app.bitcoin.label.interval":       "Mining-Intervall (s)",
  ...
  "router.ospf.lsdb": "Link State Datenbank",
  "router.ospf.log": "Protokoll",
  "router.ospf.started": "OSPF gestartet (Router-ID: {id})",
  "router.ospf.stopped": "OSPF gestoppt",
  "router.ospf.neighbor.up": "Nachbar {ip} -> Full",
  "router.ospf.neighbor.down": "Nachbar {ip} -> Down",
  "router.ospf.elected.dr": "Gewählt als DR auf {iface}",
  "router.ospf.elected.bdr": "Gewählt als BDR auf {iface}",
  "router.ospf.spf.run": "SPF: {n} Routen installiert",
