...
export default {
  ...
  "tour.step.add-pc-tool.title":    "Einen PC hinzufügen",
  "tour.step.add-pc-tool.text":     "Klicke auf das PC-Symbol in der Sidebar, um das Platzierungswerkzeug zu aktivieren.\n\nPC 2 (192.168.0.12) und Switch 1 sind bereits vorhanden.",
  "tour.step.place-pc.title":       "PC auf der Arbeitsfläche platzieren",
  "tour.step.place-pc.text":        "Klicke jetzt auf die Arbeitsfläche, um PC 1 zu platzieren.",
  ...
  "tour.step.open-pc.title":        "PC 1 öffnen",
  "tour.step.open-pc.text":         "Klicke auf PC 1, um sein Konfigurationspanel zu öffnen.",
