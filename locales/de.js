...
export default {
  ...
  "app.ipv4config.ipv6.enable": "IPv6 aktivieren",
  "app.ipv4config.ipv6.address": "IPv6-Adresse",
  "app.ipv4config.ipv6.prefix": "Präfixlänge",
  "app.ipv4config.ipv6.gateway": "IPv6-Gateway",
  "app.ipv4config.ipv6.apply": "IPv6 übernehmen",
  "app.ipv4config.ipv6.msg.applied": "IPv6 auf Schnittstelle {i} gesetzt: {ip}/{prefix}",
  "app.ipv4config.ipv6.msg.disabled": "IPv6 auf Schnittstelle {i} deaktiviert.",
  ...
  "app.mailclient.status.configSaved": "Konfiguration gespeichert",
  "app.mailclient.placeholder.host": "Mailserver (Host oder IP)",
  "app.mailclient.placeholder.port": "110",
  "app.mailclient.placeholder.user": "Benutzername",
  "app.mailclient.placeholder.pass": "Passwort",
  "app.mailclient.placeholder.smtpHost": "SMTP-Server",
  "app.mailclient.placeholder.to": "An: alice@example.local",
  "app.mailclient.placeholder.subject": "Betreff",
  "app.mailclient.placeholder.body": "Nachrichtentext…",
  "app.mailclient.label.incoming": "Eingehend (POP3 / IMAP)",
  "app.mailclient.label.outgoing": "Ausgehend (SMTP)",
  "app.mailclient.label.server": "Server",
  "app.mailclient.label.credentials": "Anmeldedaten",
  ...
  "app.mailclient.inbox.empty": "(kein Posteingang — Abrufen drücken)",
  "app.mailclient.inbox.unknownSender": "(unbekannt)",
  "app.mailclient.inbox.noSubject": "(kein Betreff)",
  "app.mailclient.status.ready": "Bereit",
  "app.mailclient.status.connecting": "Verbinde…",
  "app.mailclient.status.sending": "Sende",
  "app.mailclient.status.sent": "Nachricht gesendet",
  "app.mailclient.status.fetchDone": "{count} Nachricht(en) abgerufen",
  ...
  "router.routingtable.ipv4": "Routing-Tabelle IPv4",
  "router.routingtable.ipv6": "Routing-Tabelle IPv6",
  ...
  "sim.link.error.portInUse": "Port ist bereits belegt.",
  "switch.title": "Switch",
  ...
  "switch.tab.stp": "STP",
  "switch.stp.settings": "Spanning Tree Protokoll-Einstellungen",
  "textbox.text": "Text",
  ...
  "homerouter.dhcp.lease": "Leasetime (s)",
  "homerouter.dhcp.leases": "Aktive Leases",
  "homerouter.dhcp.invalid": "Ungültige DHCP-Konfiguration",
  "pcap.filter.placeholder": "Anzeige-Filter (z. B. ip.addr==1.2.3.4)",
  "pcap.btn.prev": "Vorherige Seite",
  "pcap.btn.next": "Nächste Seite",
  "pcap.btn.hidetab": "Tab ausblenden",
  "pcap.btn.showtab": "Tab anzeigen…",
  "pcap.col.no": "Nr.",
  "pcap.col.time": "Zeit",
  ...
  "pcap.col.info": "Info",
  "pcap.status.loading.wiregasm": "Lade Wiregasm…",
  "pcap.status.loading.pcap": "Lade PCAP…",
  "pcap.status.rendering": "Wird dargestellt…",
  "pcap.status.ready": "Bereit",
  "pcap.status.active": "Aktiv: {name} — {shown} Pakete (Offset {skip}, {matched} übereinstimmend)",
  "pcap.status.active.nocapture": "Aktiv: {name} (kein Capture geladen)",
  "pcap.status.nosession": "Keine aktive Sitzung",
  "pcap.tabs.title": "Traces:",
  "pcap.packet.select": "Paket auswählen…",
  "pcap.packet.nocapture": "Kein Capture in dieser Sitzung geladen.",
  ...
  "app.ircserver.log.listening": "IRC hört auf Port {port}",
  "app.ircserver.log.startfailed": "Start fehlgeschlagen: {reason}",
  "app.ircserver.log.stopped": "gestoppt",
  "app.ircserver.log.accepterror": "Akzeptierfehler: {reason}",
  ...
  "app.ircclient.topic.users": "{count} Nutzer",
  "app.ircclient.status.connecting": "Verbindung zu {server}:{port} wird hergestellt …",
  ...
  "app.ircclient.err.resolve": "Konnte {server} nicht auflösen.",
  ...
  "app.ircclient.err.nochan": "Zuerst einem Channel beitreten (/join #channel)",
  "app.ircclient.err.nickinuse": "Nick bereits vergeben: {nick}",
  ...
  "app.ircclient.event.selfpart": "← Verließ {chan}",
  "app.ircclient.event.userpart": "← {nick} hat {chan} verlassen",
  "app.ircclient.event.userquit": "✕ {nick} hat die Verbindung getrennt ({reason})",
  "app.ircclient.event.selfnick": "Du heißt jetzt {nick}",
  "app.ircclient.event.usernick": "{oldNick} → {newNick}",
  "app.ircclient.event.topic": "{nick} hat das Thema gesetzt: {topic}",
  "app.ircclient.event.kick": "✕ {kicked} wurde von {by} gekickt ({reason})",
  ...
  "app.terminal.commands.curl.usage": "Verwendung: curl [-v] [-I] [-X Methode] [-d Daten] [-H Header] <url>",
  "app.terminal.commands.curl.err.onlyHttp": "curl: es werden nur http://-URLs unterstützt",
  "app.terminal.commands.curl.err.noHost": "curl: kein Host in der URL",
  "app.terminal.commands.curl.err.resolve": "curl: konnte '{host}' nicht auflösen",
  "app.terminal.commands.curl.err.connect": "curl: Verbindungsfehler: {reason}",
  ...
  "app.terminal.commands.nc.err.connect": "nc: Verbindungsfehler: {reason}",
  "app.terminal.commands.nc.err.nokey": "nc: Verbindung fehlgeschlagen: kein Schlüssel",
  "app.terminal.commands.nc.err.listen": "nc: Lauschen auf Port {port} fehlgeschlagen: {reason}",
  "app.terminal.commands.nc.err.accept": "nc: Akzeptieren fehlgeschlagen: {reason}",
  "app.terminal.commands.nc.err.udpopen": "nc: UDP-Socket fehlgeschlagen: {reason}",
  "app.terminal.commands.nc.listening": "Höre auf *:{port} …",
  "app.terminal.commands.nc.connected": "Verbindung eingegangen.",
  "app.terminal.commands.nc.closed": "Verbindung geschlossen.",
  "app.terminal.commands.nc.udp.ready": "UDP → {host}:{port}  (Tippen zum Senden, Strg+C zum Beenden)",
  "app.terminal.commands.nc.udp.listening": "UDP hört auf *:{port} …",
  ...
  "firewall.policy.allow": "Alle erlauben",
  "firewall.policy.deny": "Alle verweigern",
  "firewall.col.enabled": "Ein",
  "firewall.col.direction": "Richtung",
  "firewall.col.ipversion": "IP",
  "firewall.col.protocol": "Protokoll",
  "firewall.col.srcip": "Quell-IP/CIDR",
  "firewall.col.srcport": "Quell-Port",
  "firewall.col.dstip": "Ziel-IP/CIDR",
  ...
  "firewall.action.allow": "Erlauben",
  "firewall.action.deny": "Verweigern",
  "firewall.any": "beliebig",
  "firewall.stats.passed": "Passiert",
